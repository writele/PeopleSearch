...
namespace PeopleSearch.Migrations
{
    ...
    [Migration("20190829092237_AdditionalSeed")]
            ...
            modelBuilder.Entity("PeopleSearch.Models.Address", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = 6, Address1 = "300 MLK Blvd.", Address2 = "Apt 1602", City = "Central City", State = "CA", ZipCode = 77777 },
                        new { Id = 7, Address1 = "2600 Ocean Ave", City = "Coast City", State = "WA", ZipCode = 51255 }
                    );
                });
            ...
            modelBuilder.Entity("PeopleSearch.Models.Person", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { PersonId = 6, AddressId = 6, Age = 27, FirstName = "Barry", ImageUrl = "/images/ballen.jpg", LastName = "Allen" },
                        new { PersonId = 7, AddressId = 7, Age = 34, FirstName = "John", ImageUrl = "/images/jstewart.jpg", LastName = "Stewart" }
                    );
                });
            ...
            modelBuilder.Entity("PeopleSearch.Models.PersonInterest", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { PersonId = 6, InterestId = 1 },
                        new { PersonId = 6, InterestId = 8 },
                        new { PersonId = 6, InterestId = 2 },
                        new { PersonId = 6, InterestId = 4 },
                        new { PersonId = 7, InterestId = 4 }
                    );
                });
